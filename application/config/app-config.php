...
*
*/
define('APP_BASE_URL', 'https://portal.chantroituonglai.com/');
...
*/
define('APP_ENC_KEY', '6b254bed723a69f92e95c4ffdc130124');
 ...
 */
define('APP_DB_USERNAME', 'fhstudio_30');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'CdtRh7qvxAtFwQb66AdB');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'fhstudio_30');
