    ...
    <nav class="header-nav">
        <div class="header-desktop-shell">
            <div class="header-left-cluster">
                <button type="button"
                    class="hide-menu tw-inline-flex tw-bg-transparent tw-border-0 tw-p-1 hover:tw-bg-neutral-600/10 tw-text-neutral-600 hover:tw-text-neutral-800 focus:tw-text-neutral-800 focus:tw-outline-none tw-rounded-md">
                ...
                <div id="logo"
                    class="tw-hidden md:tw-flex tw-items-center [&_img]:tw-h-10 [&_img]:tw-w-auto">
            ...
            <div class="header-center-cluster">
                <div id="top_search"
                    class="tw-inline-flex tw-relative dropdown tw-w-full tw-group/top-search"
                    data-toggle="tooltip" data-placement="bottom"
                    data-title="<?= _l('search_by_tags'); ?>">
                    <input type="search" id="search_input"
                        class="ltr:tw-pr-4 ltr:tw-pl-9 rtl:tw-pr-9 rtl:tw-pl-4 focus:!tw-ring-0 tw-w-full !tw-placeholder-neutral-500 !tw-shadow-none tw-text-neutral-800 focus:!tw-placeholder-neutral-600 hover:!tw-placeholder-neutral-600 tw-h-[42px] tw-border-0 tw-border-solid !tw-border-white !tw-bg-neutral-100 !tw-rounded-lg"
            ...
            <div class="header-right-cluster">
                ...
                <ul class="header-quick-actions">
                    <li class="icon tw-relative"
                        ...
                        data-toggle="tooltip" data-placement="bottom">
                        <a href="#" class="header-quick-create !tw-px-0 tw-group !tw-text-white" data-toggle="dropdown">
                            <span
                                class="tw-rounded-full tw-bg-primary-600 tw-text-white tw-inline-flex tw-items-center tw-justify-center tw-h-10 tw-w-10 group-hover:!tw-bg-primary-700">
                ...
                <ul class="header-utility-list">
                    ...
                    <li class="icon header-newsfeed">
                        <a href="#" class="open_newsfeed desktop header-icon-link" data-toggle="tooltip"
                    ...
                    <li class="icon header-todo">
                        <a href="<?= admin_url('todo'); ?>"
                            ...
                            data-placement="bottom" class="header-icon-link">
                            <i class="fa-regular fa-square-check fa-lg tw-shrink-0"></i>
                            <span
                                class="tw-leading-none tw-px-1 tw-py-0.5 tw-text-xs bg-warning tw-z-10 tw-absolute tw-rounded-full tw-right-0 tw-top-0.5 tw-min-w-[18px] tw-min-h-[18px] tw-inline-flex tw-items-center tw-justify-center nav-total-todos<?= $current_user->total_unfinished_todos == 0 ? ' hide' : ''; ?>">
                    ...
                    <li class="icon header-timers timer-button tw-relative"
                        ...
                        <a href="#" id="top-timers" class="top-timers header-icon-link tw-group" data-toggle="dropdown">
                            <i
                            ...
                            <span
                                class="tw-leading-none tw-px-1 tw-py-0.5 tw-text-xs bg-success tw-z-10 tw-absolute tw-rounded-full tw-right-0 tw-top-0.5 tw-min-w-[18px] tw-min-h-[18px] tw-inline-flex tw-items-center tw-justify-center icon-started-timers<?= $totalTimers = count($startedTimers) == 0 ? ' hide' : ''; ?>">
                                <?= count($startedTimers); ?>
                            </span>
                        </a>
