...
class VerifyPurchase extends AdminController
{
    ...
    {
        // Bypass any remote verification for local/testing
        $response = ['status' => true, 'message' => LB_TEXT_VERIFIED_RESPONSE];
        update_option('flutex_admin_api_enabled', 1);
        // If you still want to exercise the normal flow, revert to the original line below
    ...
    {
        // Bypass purchase verification in local/testing
        update_option('flutex_admin_api_enabled', 1);
