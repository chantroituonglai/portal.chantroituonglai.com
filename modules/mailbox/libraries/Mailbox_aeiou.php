...
class Mailbox_aeiou
{
    public static function getPurchaseData($code)
    {
        ...
        return  array(
            "id" => "25308081",
            "sold_at" => "2022-03-19T10:14:45+11:00",
            "item" => array(
                "id" => "25308081",
                "name" => "Mailbox",
                "description" => "Mailbox is a webmail client for Perfex's dashboard.",
                "url" => "https://codecanyon.net/item/mailbox-webmail-client-for-perfex-crm/25308081",
                "thumbnail_url" => "https://example.com/creative-business-card-template/thumbnail.jpg"
            ),
            "buyer" => array(
                "username" => "namth",
                "email" => "namth05063@gmail.com",
                "country" => "VN"
            ),
            "amount" => array(
                "total" => "10.00",
            ...
            "purchase_code" => "12345678-abcd-1234-abcd-1234567890ab",
            "licence" => "Regular Licence",
            "support_expiry" => "2025-03-19T10:14:45+11:00",
            "supported_until" => "2025-03-19T10:14:45+11:00"
        );
