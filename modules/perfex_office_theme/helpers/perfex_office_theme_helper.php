...
{
    echo '<link href="' . module_dir_url(PERFEX_OFFICE_THEME, 'assets/css/clients/clients.css?ver=2') . '"  rel="stylesheet" type="text/css" >';
...
{
    echo '<link href="' . base_url('modules/perfex_office_theme/assets/css/theme_styles.css?ver=4') . '"  rel="stylesheet" type="text/css" >';
    echo '<script src="' . module_dir_url(PERFEX_OFFICE_THEME, 'assets/js/third-party/nanobar.js') . '"></script>';
