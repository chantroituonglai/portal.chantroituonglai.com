...
class Predix extends AdminController
{
    ...
    public function generateChatAiResponse($chat_id)
    {
        ...
        $open_ai = new PredixOpenAi($open_ai_key);
...
//        if ($this->input->post()){
        $open_ai = new PredixOpenAi(get_option('predix_openai_secret_key'));
...
//        if ($this->input->post()){
    ...
    public function handle_template_call($template_id)
    {
        ...
        if ($this->input->post()) {
            ...
            $openAi = new PredixOpenAi(get_option('predix_openai_secret_key'));
