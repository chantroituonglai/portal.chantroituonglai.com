...
$CI->db->query("INSERT INTO `".db_prefix()."predix_template_categories` (`category_name`, `category_description`, `is_enabled`, `created_at`) VALUES ('Emails', 'Creative templates for email creation',1,'2023-06-18 01:47:26');");
$CI->db->query("INSERT INTO `".db_prefix()."predix_template_categories` (`category_name`, `category_description`, `is_enabled`, `created_at`) VALUES ('Social Media', 'Flash tools for social media content',1,'2023-06-18 01:47:26');");
$CI->db->query("INSERT INTO `".db_prefix()."predix_template_categories` (`category_name`, `category_description`, `is_enabled`, `created_at`) VALUES ('Contents', 'Tools for writing creatives for different moods and tasks',1,'2023-06-18 01:47:26');");
$CI->db->query("INSERT INTO `".db_prefix()."predix_template_categories` (`category_name`, `category_description`, `is_enabled`, `created_at`) VALUES ('Blog Posts', 'Content for the generating articles, blog post',1,'2023-06-18 01:47:26');");
$CI->db->query("INSERT INTO `".db_prefix()."predix_template_categories` (`category_name`, `category_description`, `is_enabled`, `created_at`) VALUES ('Video', 'Video creation tools from idea to script for millions of views',1,'2023-06-18 01:47:26');");
$CI->db->query("INSERT INTO `".db_prefix()."predix_template_categories` (`category_name`, `category_description`, `is_enabled`, `created_at`) VALUES ('Perfex', 'Templates for Perfex CRM',1,'2023-06-18 01:47:26');");
...
$customPrompt = '[{"input_name":"product","input_label":"Product\/Service","input_field_type":"text"}]';
$customPrompt = $CI->db->escape_str($customPrompt);  // Escape the value
$CI->db->query("INSERT INTO `".db_prefix()."predix_templates` (`template_name`, `perfex_core`, `template_description`, `template_category_id`, `template_icon`, `custom_prompt`, `custom_inputs`, `is_enabled`, `created_at`) VALUES ('Facebook Ads', 0,'Create effective Facebook ads for your product or service',4,'fab fa-facebook-square','Write facebook ads about this product or service {{product}}','".$customPrompt."', 1,'2023-06-18 03:11:16');");
...
$customPrompt = '[{"input_name":"product_name","input_label":"Product Name","input_field_type":"text"},{"input_name":"short_description","input_label":"Product Short Description","input_field_type":"textarea"}]';
$customPrompt = $CI->db->escape_str($customPrompt);  // Escape the value
$CI->db->query("INSERT INTO `".db_prefix()."predix_templates` (`template_name`, `perfex_core`, `template_description`, `template_category_id`, `template_icon`, `custom_prompt`, `custom_inputs`, `is_enabled`, `created_at`) VALUES ('Product Description', 0,'Create creative product descriptions from example words',5,'fa-solid fa-info-circle','Write a product description about a product with name {{product_name}} and here is a short description about this product {{short_description}}','".$customPrompt."', 1,'2023-06-18 03:11:16');");
